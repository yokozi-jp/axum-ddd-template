...
```typescript
// features/order/application/place_order/handler.ts
import { Order } from '@/features/order/domain/order';
import { IOrderRepository } from '@/features/order/domain/repository';
import { IProductRepository } from '@/features/product/domain/repository';
...
import { OrderNotFoundError, ProductNotFoundError } from '@/shared/application/errors';
...
```typescript
// features/order/application/place_order/command.ts
...
// features/order/application/get_order/query.ts
export interface GetOrderQuery {
  orderId: string;
}

// features/order/application/get_order/result.ts
...
```typescript
// features/order/infrastructure/http/rest/controllers/order_controller.ts
import { Request, Response, NextFunction } from 'express';
import { IPlaceOrderUseCase } from '@/features/order/application/place_order/port';
import { IGetOrderUseCase } from '@/features/order/application/get_order/port';
...
import { IUnitOfWork } from '@/shared/application/unit_of_work';
import { IEventPublisher } from '@/shared/application/event_publisher';
import { PlaceOrderHandler } from '@/features/order/application/place_order/handler';
import { PostgresOrderRepository } from '@/features/order/infrastructure/persistence/postgres/order_repository';
import { PostgresProductRepository } from '@/features/product/infrastructure/persistence/postgres/product_repository';
import { PostgresUnitOfWork } from '@/shared/infrastructure/database/postgres/unit_of_work';
import { RabbitMQEventPublisher } from '@/shared/infrastructure/messaging/rabbitmq/event_publisher';
import { OrderController } from '@/features/order/infrastructure/http/rest/controllers/order_controller';
...
**Package by Feature**: Each feature is self-contained with domain/application/infrastructure. Features reference other features by ID only.
